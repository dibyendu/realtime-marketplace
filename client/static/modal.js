...
var ModalForm = function (_React$Component) {
	...
	function ModalForm() {
		...
		var _this = _possibleConstructorReturn(this, (ModalForm.__proto__ || Object.getPrototypeOf(ModalForm)).call(this));
		...
		value: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'a',
						{ className: 'close-btn', href: '#', title: 'Close', onClick: function onClick() {
								return _this2.handleClose();
							} },
						React.createElement('img', { src: 'static/cross.png' })
					),
					React.createElement(_form2.default, { saveNewInfo: true, initData: userInfo, extraData: Object.assign(this.props.mapData, {
							first: $('#fname').val(),
							last: $('#lname').val(),
							ip: $('#ip').val()
				...
				React.createElement('div', { className: 'modal-bg', onClick: function onClick(e) {
						e.preventDefault();
						_this2.handleClose();
					} })
			);
...
window.showModal = function (key, mapData) {
	return ReactDOM.render(React.createElement(ModalForm, { key: key, mapData: mapData }), document.getElementById('modal'));
};
